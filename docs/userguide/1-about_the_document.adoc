...
This document is intended for users of the TITAN TTCN–3 Test Toolset (product number: CRL 113 200/4). In addition to this document, readers requiring additional information on creating and building test suites or writing test ports are referred to the link:https://github.com/nagim/test/master/docs/referenceguide/README.adoc[TITAN Programmer´s Technical Reference for TITAN TTCN-3 Test Executor].
